...
const char* password = "muinomuino";

String internal_server = "http://000.000.000.000";
...
String City      = "Amsterdam";                              // Your home city See: http://bulk.openweathermap.org/sample/
String Latitude  = "00.000";                                 // Latitude of your location in decimal degrees
...
const char* ntpServer = "0.nl.pool.ntp.org";                 // Or, choose a time server close to you, but in most cases it's best to use pool.ntp.org to find an NTP server
